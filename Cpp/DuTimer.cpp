...
void DuTimer::Start(string label) {
#ifdef DEBUG_TIMER_ON
  Map[label] = chrono::steady_clock::now();
#endif  // DEBUG_TIMER_ON
}

double DuTimer::End(string label, bool silence) {
#ifdef DEBUG_TIMER_ON
...
void DuTimer::StartAverageWindow(string label) {
#ifdef DEBUG_TIMER_ON
  AverageWindowMap[label].startTime = chrono::steady_clock::now();
#endif  // DEBUG_TIMER_ON
}
double DuTimer::EndAverageWindow(string label, bool silence) {
#ifdef DEBUG_TIMER_ON
