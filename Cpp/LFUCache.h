...
class LFUCache {
 private:
  ...
  int m_size;
  int m_min_freq;
  unordered_map<int, list<tuple<int, int, int>>>
      m_freq_to_nodes;  // freq to list of {key, val, freq}
  unordered_map<int, list<tuple<int, int, int>>::iterator>
      m_key_to_nodeit;  // key to list iterator
 public:
